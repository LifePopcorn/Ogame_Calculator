...
/* =========================================================================
   2. ДАННЫЕ: СТОИМОСТИ, ИКОНКИ, КОРАБЛИ
   ========================================================================= */
...
/* =========================================================================
   4. LOCALSTORAGE (безопасные обёртки)
   ========================================================================= */
...
// Универсальная функция: создаёт <img> с fallback при ошибке загрузки
function createIconWithFallback(src, alt, size = 20) {
  ...
  img.addEventListener('error', function handler() {
    ...
    img.removeEventListener('error', handler); // убираем утечку
...
/* =========================================================================
   9. ПОСТРОЕНИЕ ТАБЛИЦ (унифицированные функции)
   ========================================================================= */

// Общая функция создания строки таблицы с полями from/to/planets
...
/* =========================================================================
   12. ФОРМАТИРОВАНИЕ ВХОДНЫХ ДАННЫХ (тысячные разделители)
   ========================================================================= */
...
/* =========================================================================
   14. СОХРАНЕНИЕ / ВОССТАНОВЛЕНИЕ ВХОДНЫХ ДАННЫХ
   ========================================================================= */
...
// Универсальная функция сохранения всех строк таблицы
...
// Универсальная функция восстановления строк таблицы
...
/* =========================================================================
   17. "СУММА ПО ВСЕМ ВКЛАДКАМ" И КОРОБКИ
   ========================================================================= */
...
/* =========================================================================
   22. ВОССТАНОВЛЕНИЕ ИЗ LOCALSTORAGE ПРИ СТАРТЕ
   ========================================================================= */
